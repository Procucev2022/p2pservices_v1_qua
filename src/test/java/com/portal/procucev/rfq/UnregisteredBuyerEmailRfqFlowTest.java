...
class UnregisteredBuyerEmailRfqFlowTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(emailProcessorService, "buyerPortalUrl", "https://qua.procucev.com/buyer");
    ...
    void testCompleteUnregisteredBuyerLifecycle() {
        ...
        verify(acknowledgementEmailService).sendDemoBuyerRegistrationEmail(eq(senderEmail), eq("Jane Doe"), eq("https://qua.procucev.com/buyer"));
