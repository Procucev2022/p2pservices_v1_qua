    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/error", "/authenticate", "/mobile/**", "/partialvendor/**","/automate/**","/api/zoho/webhook/**", "/rest/users/getBuyerByEmail", "/rest/users/getSellerByEmail", "/rfq/email/**").permitAll()
