...
public class EmailScheduler {
    ...
    public void onApplicationReady() {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                log.info("Initial Email RFQ Processing complete: Status={}, EmailsProcessed={}, RFQsCreated={}, Errors={}, Duration={}",
                        stats.getStatus(), stats.getEmailsProcessed(), stats.getRfqsCreated(), stats.getErrors(), stats.getExecutionTime());
            } catch (Exception e) {
                log.error("Initial Email RFQ Job failed: {}", e.getMessage(), e);
            }
        });
    }
    ...
    @SchedulerLock(name = "emailRfqProcessingJob", lockAtMostFor = "55s", lockAtLeastFor = "2s")
